  ...
  return (
    <div className="privacy-section">
      <div className="privacy-section--container column-layout">
        <h1>Privacy Policy for Janus</h1>

        <p>
          At Janus, accessible from https://janus.ioak.org, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Janus and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Janus. This policy is not applicable to any
        ...
        <p>
          Janus follows a standard procedure of using log files. These files log
        ...
        <p>
          Like any other website, Janus uses 'cookies'. These cookies are used
        ...
        <p>
          ...
          advertising partners of Janus.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Janus, which are sent directly
        ...
        <p>
          Note that Janus has no access to or control over these cookies that
        ...
        <p>
          Janus's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Janus does not knowingly collect any Personal Identifiable Information
