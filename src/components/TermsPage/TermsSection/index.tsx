    ...
    <div className="terms-section">
      <div className="terms-section--container column-layout">
        ...
        <p>
          ...
          use of Janus's Website, located at https://janus.ioak.org.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Janus if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Janus, you agreed to use
          cookies in agreement with the Janus's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Janus and/or its licensors own the
          intellectual property rights for all material on Janus. All
          intellectual property rights are reserved. You may access this from
          Janus for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Janus</li>
          <li>Sell, rent or sub-license material from Janus</li>
          <li>Reproduce, duplicate or copy material from Janus</li>
          <li>Redistribute content from Janus</li>
        </ul>
        ...
        <p>
          ...
          Janus does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Janus,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Janus shall not be liable for
        ...
        <p>
          Janus reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Janus a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Janus; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Janus. Please include your name, your
        ...
        <p>
          No use of Janus's logo or other artwork will be allowed for linking
